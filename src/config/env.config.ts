  ...
  private loadEnv() {
    ...
    if (process.env?.DOCKER_ENV === 'true') {
      ...
      this.env.SERVER.PORT =
        Number.parseInt(process.env.PORT) || Number.parseInt(process.env.SERVER_PORT) || 8081;
    }
  }
  ...
  private envProcess(): Env {
    return {
      SERVER: {
        ...
        PORT: Number.parseInt(process.env.PORT) || Number.parseInt(process.env.SERVER_PORT) || 8081,
